...
def generate_launch_description():
    ...
    #    DeclareLaunchArgument('video_stream', default_value='http://172.17.0.1:8080/stream?topic=/camera/rgb/image_raw', description='URL of the video stream'),
    #    Node(
    #        package='web_video_server',#web_video_server
    #        executable='web_video_server',
    #        name='web_video_server',
    #        output='screen',
    #        parameters=[{'video_stream': 'http://172.17.0.1:8080/stream?topic=/camera/rgb/image_raw'}]
    #    ),
    #])
...
def start_node(context, *args, **kwargs):
    ...
    moveit_config = (
        ...
        .moveit_cpp(
            file_path=get_package_share_directory("projet_robot_tiago") + "/launch/pipelines.yaml"
        )
    ...
    node = Node(
        package="projet_robot_tiago",
        executable="projet_global",
        output="both",
        parameters=[
